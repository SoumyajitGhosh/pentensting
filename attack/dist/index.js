...
//Batching and pushing Promises into a in-memory object
function main() {
    return __awaiter(this, void 0, void 0, function* () {
        for (let i = 0; i < 1000000; i += 100) {
            ...
            for (let j = 0; j < 100; j++) {
                promises.push(sendRequest(i + j)); // pushing 100 promises
            }
            yield Promise.all(promises); // await for 100 promises, then move on with iteration
        }
    });
}
main();
